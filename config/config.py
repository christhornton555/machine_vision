...
# Define Mediapipe hand landmarks and connections
HAND_PARTS = {
    "WRIST": 0,
    "THUMB_CMC": 1,
    "THUMB_MCP": 2,
...
# Hand connections between landmarks
HAND_CONNECTIONS = [
    (HAND_PARTS['WRIST'], HAND_PARTS['THUMB_CMC']),
    (HAND_PARTS['THUMB_CMC'], HAND_PARTS['THUMB_MCP']),
    (HAND_PARTS['THUMB_MCP'], HAND_PARTS['THUMB_IP']),
    (HAND_PARTS['THUMB_IP'], HAND_PARTS['THUMB_TIP']),
    (HAND_PARTS['WRIST'], HAND_PARTS['INDEX_FINGER_MCP']),
    (HAND_PARTS['INDEX_FINGER_MCP'], HAND_PARTS['INDEX_FINGER_PIP']),
    (HAND_PARTS['INDEX_FINGER_PIP'], HAND_PARTS['INDEX_FINGER_DIP']),
    (HAND_PARTS['INDEX_FINGER_DIP'], HAND_PARTS['INDEX_FINGER_TIP']),
    (HAND_PARTS['WRIST'], HAND_PARTS['MIDDLE_FINGER_MCP']),
    (HAND_PARTS['MIDDLE_FINGER_MCP'], HAND_PARTS['MIDDLE_FINGER_PIP']),
    (HAND_PARTS['MIDDLE_FINGER_PIP'], HAND_PARTS['MIDDLE_FINGER_DIP']),
    (HAND_PARTS['MIDDLE_FINGER_DIP'], HAND_PARTS['MIDDLE_FINGER_TIP']),
    (HAND_PARTS['WRIST'], HAND_PARTS['RING_FINGER_MCP']),
    (HAND_PARTS['RING_FINGER_MCP'], HAND_PARTS['RING_FINGER_PIP']),
    (HAND_PARTS['RING_FINGER_PIP'], HAND_PARTS['RING_FINGER_DIP']),
    (HAND_PARTS['RING_FINGER_DIP'], HAND_PARTS['RING_FINGER_TIP']),
    (HAND_PARTS['WRIST'], HAND_PARTS['PINKY_MCP']),
    (HAND_PARTS['PINKY_MCP'], HAND_PARTS['PINKY_PIP']),
    (HAND_PARTS['PINKY_PIP'], HAND_PARTS['PINKY_DIP']),
    (HAND_PARTS['PINKY_DIP'], HAND_PARTS['PINKY_TIP'])
]

# Mediapipe-like hand landmark colors
HAND_KEYPOINT_COLORS = {
    HAND_PARTS['WRIST']: (0, 255, 255),  # Yellow
    HAND_PARTS['THUMB_CMC']: (0, 255, 0),  # Green
    HAND_PARTS['THUMB_MCP']: (0, 200, 0),
    HAND_PARTS['THUMB_IP']: (0, 150, 0),
    HAND_PARTS['THUMB_TIP']: (0, 100, 0),
    HAND_PARTS['INDEX_FINGER_MCP']: (255, 0, 0),  # Red
    HAND_PARTS['INDEX_FINGER_PIP']: (200, 0, 0),
    HAND_PARTS['INDEX_FINGER_DIP']: (150, 0, 0),
    HAND_PARTS['INDEX_FINGER_TIP']: (100, 0, 0),
    HAND_PARTS['MIDDLE_FINGER_MCP']: (0, 0, 255),  # Blue
    HAND_PARTS['MIDDLE_FINGER_PIP']: (0, 0, 200),
    HAND_PARTS['MIDDLE_FINGER_DIP']: (0, 0, 150),
    HAND_PARTS['MIDDLE_FINGER_TIP']: (0, 0, 100),
    HAND_PARTS['RING_FINGER_MCP']: (255, 0, 255),  # Pink
    HAND_PARTS['RING_FINGER_PIP']: (200, 0, 200),
    HAND_PARTS['RING_FINGER_DIP']: (150, 0, 150),
    HAND_PARTS['RING_FINGER_TIP']: (100, 0, 100),
    HAND_PARTS['PINKY_MCP']: (255, 255, 0),  # Cyan
    HAND_PARTS['PINKY_PIP']: (200, 200, 0),
    HAND_PARTS['PINKY_DIP']: (150, 150, 0),
    HAND_PARTS['PINKY_TIP']: (100, 100, 0)
}
